...
require_once "../../libs/database.php";
 ...
 if(isset($_POST['btn-submit']) ) {
	$result = list_all_user();
	extract($_REQUEST);
    // registration($fullname, $username, $email, $password); 
	// $_SESSION[''] = "Đăng ký tài khoản thành công";
	 if(isset($_REQUEST) == $result['username'] ) {
		 $a = "tài khoản đã tồn tại";
		header('Location:' . ROOT . 'admin/go/registration.php');
	}else{
		registration($fullname, $username, $email, $password); 
		 $b = "Thêm dữ liệu thành công";
