			...
			<div class="col-md-3 header-left">
				...
				<div class="head-nav">
					...
					<ul class="cl-effect-16">
						...
						<li><a href="album.php" data-hover="ALBUM">ALBUM</a></li>
						<li><a href="dichvu.php" data-hover="DỊCH VỤ">DỊCH VỤ</a></li>
						<li><a href="datlich.php" data-hover="ĐẶT LỊCH">ĐẶT LỊCH</a></li>
