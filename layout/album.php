...
$service = list_limit_service_two();
$service_all = list_all_album();
$album = list_all_album();
$slider = list_all_slider();
$service_three = list_limit_service_three();
...
<head>
	<title>Fashion&Beauty a Fashion Category Flat Bootstarp Responsive Website Template | Services :: w3layouts</title>
...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="col-md-3 header-left">
				...
				<div class="head-nav">
					<span class="menu"><a href="<?=ROOT?>index.php"><img src="images/menu.png" alt=""></a></span>
	...
	<div class="services">
		<div class="container">
			<h3>Style 2019</h3>
			<?php foreach($service_three as $s) : ?>
			<div class="col-md-3 services-left">
				<img src="../images/<?=$s['image']?>" alt=" " class="img-responsive">
		...
		<div class="container">
			...
			<?php foreach($service_all as $s) : ?>
			<div class="ok">
				<img height="260px" src="../images/<?=$s['image']?>" alt=" " class="img-responsive">
		...
		<div class="nbs-flexisel-container">
			<div class="nbs-flexisel-inner">
				...
				<?php foreach($slider as $slide) :?>	
					<li class="nbs-flexisel-item" style="width: 300px; height: 310px;">
						<div class="sliderfig-grid">
							<img src="../images/<?=$slide['image']?>" alt=" " class="img-responsive">
						</div>
					</li>
					<?php endforeach ;?>
	...
	<div class="footer">
		<div class="container">
			<p>Copyrights © 2015 Fashion&Beauty. All rights reserved | Design by <a
